...
public class PostReplyController {
    ...
    public RspTemplate<ChatRoomRspDto> replyToPost(@PathVariable Long postId, @Valid @RequestBody PostReplyReqDto req) {
        Long partnerId = securityUtil.getCurrentUserId();
        ChatRoomRspDto data = chatService.replyToPost(postId, partnerId, req);
