...
public class AdminBalGameSummaryRspDto {
    ...
    @Schema(description = "옵션 A 부가 설명")
    private String optionADesc;

    @Schema(description = "옵션 B 부가 설명")
    ...
    @Schema(description = "BAL-APPLY 기반 등록 시 신청자 user id (자체 등록이면 null)", example = "42")
