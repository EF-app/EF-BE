...
public class AdminPostItController {
    ...
    @Operation(summary = "포스트잇 목록 조회",
            description = "keyword(닉네임/본문 LIKE), categoryCode, isHidden, isDeleted, userId 동적 필터")
    @GetMapping
    public RspTemplate<Page<AdminPostItRspDto>> getPostIts(
        ...
        return new RspTemplate<>(HttpStatus.OK, "포스트잇 목록을 조회했습니다.",
                adminPostItService.getPostIts(keyword, categoryCode, isHidden, isDeleted, userId, pageable));
    }
