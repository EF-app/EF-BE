...
@Builder
@AllArgsConstructor
@Schema(description = "관리자 에러 로그 목록 항목 (stacktrace·metadata 제외)")
public class AdminErrorLogItemRspDto {
    ...
    @Schema(description = "예외 메시지", example = "Cannot invoke ... because \"x\" is null")
    ...
    public static AdminErrorLogItemRspDto from(SystemErrorLog e) {
        return AdminErrorLogItemRspDto.builder()
                .id(e.getId())
